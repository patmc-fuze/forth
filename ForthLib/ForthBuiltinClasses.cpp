...
#define RCSTRING_SLOP 0
    ...
    {
        METHOD(     "_%new%_",              oFileInStreamNew ),
    ...
    {
        METHOD(     "_%new%_",              oConsoleInStreamNew ),
    ...
    {
        METHOD(     "_%new%_",              oFileOutStreamNew ),
    ...
    {
        METHOD(     "_%new%_",              oConsoleOutStreamNew ),
    ...
    {
        METHOD(     "_%new%_",              oFunctionOutStreamNew ),
