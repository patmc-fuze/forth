...
namespace OSocket
{
    ...
    baseMethodEntry oSocketMembers[] =
    {
        ...
        METHOD_RET("open", oSocketOpenMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("close", oSocketCloseMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("bind", oSocketBindMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("listen", oSocketListenMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("accept", oSocketAcceptMethod, OBJECT_TYPE_TO_CODE(kDTIsMethod, kBCISocket)),
        METHOD_RET("connect", oSocketConnectMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("send", oSocketSendMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("sendTo", oSocketSendToMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("recv", oSocketRecvMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("recvFrom", oSocketRecvFromMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("read", oSocketReadMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
        METHOD_RET("write", oSocketWriteMethod, NATIVE_TYPE_TO_CODE(kDTIsMethod, kBaseTypeInt)),
