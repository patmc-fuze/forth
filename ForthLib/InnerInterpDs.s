...
InnerInterpreter:
	...
	ldr	r9, .opsTable			@ r9 = table of ops implemented in assembler
	ldr	r10, [r4, #n_asm_ops]	@ r10 = number of ops implemented in assembler
...
interpLoopExecuteEntry:
	cmp	r0, r10					@ is opcode builtin assembler op?
	bge	.II3
	@ handle builtin ops
	ldr	r1, [r9, r0, lsl #2]
	bx	r1
...
.IIExit:
	...
	stmia	r1!, {r5-r7}			@ save IP, SP, RP in core
	pop	{r4-r12, pc}
